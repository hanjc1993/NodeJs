...
test("resolveUrl", function(t) {
  ...
  t.equal(
    resolveUrl(loc, "/static/scripts/main.js"),
    "https://example.com/static/scripts/main.js"
  )

  t.equal(
    resolveUrl(loc, "/static/scripts/main.js", "../source-maps/main.js.map"),
    "https://example.com/static/source-maps/main.js.map"
  )

  t.equal(
    resolveUrl(loc, "/static/scripts/main.js", "../source-maps/main.js.map", "../coffee/app.coffee"),
